...
import com.tlkj.gw.dao.XT_PUSH_Dao;
import com.tlkj.gw.entity.XT_PUSH;

@RequestMapping("/rest/push")
public class XT_PUSHController extends TLKJController {
    public final static String BASE_URL = "/push";
    static Logger log = Logger.getLogger(XT_PUSHController.class);
    private XT_PUSH_Dao dao = new XT_PUSH_Dao(); 
    ...
    public void list() {
        ...
        DBResult dbret = dao.Query("*", "XT_PUSH", cWhereParm, cOrderBy, iPageNo, iPageSize);
    ...
    public void save() {
        ...
        vo = (XT_PUSH) RequestUtil.readFromRequest(this.request, vo);
    ...
    public void find_item() {
        ...
        XT_PUSH obj = dao.FindItem(cURL_ID);
