...
public class XT_NEWSController extends TLKJController {
    public final static String BASE_URL = "/news";
    static Logger log = Logger.getLogger(XT_NEWSController.class);
    private XT_NEWS_Dao dao = new XT_NEWS_Dao(); 
    ...
    public void list() {
        ...
        DBResult dbret = dao.Query("*", "XT_NEWS", cWhereParm, cOrderBy, iPageNo, iPageSize);
    ...
    public void save() {
        ...
        vo = (XT_NEWS) RequestUtil.readFromRequest(this.request, vo);
    ...
    public void find_item() {
        ...
        XT_NEWS obj = dao.FindItem(cURL_ID);
