...
public class XT_DEVICEController extends TLKJController {
    public final static String BASE_URL = "/device";
    static Logger log = Logger.getLogger(XT_DEVICEController.class);
    private XT_DEVICE_Dao dao = new XT_DEVICE_Dao(); 
    ...
    public void list() {
        ...
        DBResult dbret = dao.Query("*", "XT_DEVICE", cWhereParm, cOrderBy, iPageNo, iPageSize);
    ...
    public void save() {
        ...
        vo = (XT_DEVICE) RequestUtil.readFromRequest(this.request, vo);
    ...
    public void find_item() {
        ...
        XT_DEVICE obj = dao.FindItem(cURL_ID);
