...
@RequestMapping("/rest/phone_book")
public class XT_PHONE_BOOKController extends TLKJController {
    public final static String BASE_URL = "/phone_book";
    static Logger log = Logger.getLogger(XT_PHONE_BOOKController.class);
    private XT_PHONE_BOOK_Dao dao = new XT_PHONE_BOOK_Dao(); 
    ...
    public void list() {
        ...
        DBResult dbret = dao.Query("*", "XT_PHONE_BOOK", cWhereParm, cOrderBy, iPageNo, iPageSize);
    ...
    public void save() {
        ...
        vo = (XT_PHONE_BOOK) RequestUtil.readFromRequest(this.request, vo);
    ...
    public void find_item() {
        ...
        XT_PHONE_BOOK obj = dao.FindItem(cURL_ID);
