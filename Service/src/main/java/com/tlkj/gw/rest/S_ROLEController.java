...
import com.tlkj.gw.dao.S_ROLE_Dao;
import com.tlkj.gw.entity.S_ROLE;

@RequestMapping("/rest/role")
public class S_ROLEController extends TLKJController {
    public final static String BASE_URL = "/role";
    static Logger log = Logger.getLogger(S_ROLEController.class);
    private S_ROLE_Dao dao = new S_ROLE_Dao(); 
    ...
    public void list() {
        ...
        String cWhereParm = " (role_id >0) ";
        String cOrderBy = " role_id asc";
        DBResult dbret = dao.Query("*", "S_ROLE", cWhereParm, cOrderBy, iPageNo, iPageSize);
    ...
    public void save() {
        ...
        vo = (S_ROLE) RequestUtil.readFromRequest(this.request, vo);
    ...
    public void find_item() {
        ...
        S_ROLE obj = dao.FindItem(cURL_ID);
