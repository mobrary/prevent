...
import com.tlkj.gw.dao.XT_GW_GRANT_Dao;
import com.tlkj.gw.entity.XT_GW_GRANT;

@RequestMapping("/rest/gw_grant")
public class XT_GW_GRANTController extends TLKJController {
    public final static String BASE_URL = "/gw_grant";
    static Logger log = Logger.getLogger(XT_GW_GRANTController.class);
    private XT_GW_GRANT_Dao dao = new XT_GW_GRANT_Dao(); 
    ...
    public void list() {
        ...
        DBResult dbret = dao.Query("*", "XT_GW_GRANT", cWhereParm, cOrderBy, iPageNo, iPageSize);
    ...
    public void save() {
        ...
        vo = (XT_GW_GRANT) RequestUtil.readFromRequest(this.request, vo);
    ...
    public void find_item() {
        ...
        XT_GW_GRANT obj = dao.FindItem(cURL_ID);
