...
public class XT_NOTICEController extends TLKJController {
    public final static String BASE_URL = "/notice";
    static Logger log = Logger.getLogger(XT_NOTICEController.class);
    private XT_NOTICE_Dao dao = new XT_NOTICE_Dao(); 
    ...
    public void list() {
        ...
        String cWhereParm = "";
        String cOrderBy = " notice_id asc";
        DBResult dbret = dao.Query("*", "XT_NOTICE", cWhereParm, cOrderBy, iPageNo, iPageSize);
    ...
    public void save() {
        ...
        vo = (XT_NOTICE) RequestUtil.readFromRequest(this.request, vo);
    ...
    public void find_item() {
        ...
        XT_NOTICE obj = dao.FindItem(cURL_ID);
