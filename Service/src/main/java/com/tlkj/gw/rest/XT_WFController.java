...
public class XT_WFController extends TLKJController {
    public final static String BASE_URL = "/wf";
    static Logger log = Logger.getLogger(XT_WFController.class);
    private XT_WF_Dao dao = new XT_WF_Dao(); 
    ...
    public void list() {
        ...
        String cWhereParm = "";
        String cOrderBy = " wf_id asc";
        DBResult dbret = dao.Query("*", "XT_WF", cWhereParm, cOrderBy, iPageNo, iPageSize);
    ...
    public void save() {
        ...
        int iCode = 0;
        XT_WF vo = new XT_WF();
        vo = (XT_WF) RequestUtil.readFromRequest(this.request, vo);
    ...
    public void find_item() {
        ...
        XT_WF obj = dao.FindItem(cURL_ID);
