...
public class XT_ARCHIVEController extends TLKJController {
    public final static String BASE_URL = "/archive";
    static Logger log = Logger.getLogger(XT_ARCHIVEController.class);
    private XT_ARCHIVE_Dao dao = new XT_ARCHIVE_Dao(); 
    ...
    public void list() {
        ...
        DBResult dbret = dao.Query("*", "XT_ARCHIVE", cWhereParm, cOrderBy, iPageNo, iPageSize);
    ...
    public void save() {
        ...
        vo = (XT_ARCHIVE) RequestUtil.readFromRequest(this.request, vo);
    ...
    public void find_item() {
        ...
        XT_ARCHIVE obj = dao.FindItem(cURL_ID);
