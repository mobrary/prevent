...
@RequestMapping("/rest/feed_back")
public class XT_FEED_BACKController extends TLKJController {
    public final static String BASE_URL = "/feed_back";
    static Logger log = Logger.getLogger(XT_FEED_BACKController.class);
    private XT_FEED_BACK_Dao dao = new XT_FEED_BACK_Dao(); 
    ...
    public void list() {
        ...
        String cWhereParm = "";
        String cOrderBy = " id asc";
        DBResult dbret = dao.Query("*", "XT_FEED_BACK", cWhereParm, cOrderBy, iPageNo, iPageSize);
    ...
    public void save() {
        ...
        vo = (XT_FEED_BACK) RequestUtil.readFromRequest(this.request, vo);
    ...
    public void find_item() {
        ...
        XT_FEED_BACK obj = dao.FindItem(cURL_ID);
