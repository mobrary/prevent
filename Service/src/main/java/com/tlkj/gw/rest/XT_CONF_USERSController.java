...
@RequestMapping("/rest/conf_users")
public class XT_CONF_USERSController extends TLKJController {
    public final static String BASE_URL = "/conf_users";
    static Logger log = Logger.getLogger(XT_CONF_USERSController.class);
    private XT_CONF_USERS_Dao dao = new XT_CONF_USERS_Dao(); 
    ...
    public void list() {
        ...
        DBResult dbret = dao.Query("*", "XT_CONF_USERS", cWhereParm, cOrderBy, iPageNo, iPageSize);
    ...
    public void save() {
        ...
        vo = (XT_CONF_USERS) RequestUtil.readFromRequest(this.request, vo);
    ...
    public void find_item() {
        ...
        XT_CONF_USERS obj = dao.FindItem(cURL_ID);
