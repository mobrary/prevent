...
import com.tlkj.gw.dao.S_CONSACT_Dao;
import com.tlkj.gw.entity.S_CONSACT;

@RequestMapping("/rest/consact")
public class S_CONSACTController extends TLKJController {
    public final static String BASE_URL = "/consact";
    static Logger log = Logger.getLogger(S_CONSACTController.class);
    private S_CONSACT_Dao dao = new S_CONSACT_Dao(); 
    ...
    public void list() {
        ...
        String cWhereParm = "";
        String cOrderBy = " itemid asc";
        DBResult dbret = dao.Query("*", "S_CONSACT", cWhereParm, cOrderBy, iPageNo, iPageSize);
    ...
    public void save() {
        ...
        vo = (S_CONSACT) RequestUtil.readFromRequest(this.request, vo);
    ...
    public void find_item() {
        ...
        S_CONSACT obj = dao.FindItem(cURL_ID);
