...
import com.tlkj.gw.dao.XT_TYPE_Dao;
import com.tlkj.gw.entity.XT_TYPE;

@RequestMapping("/rest/type")
public class XT_TYPEController extends TLKJController {
    public final static String BASE_URL = "/type";
    static Logger log = Logger.getLogger(XT_TYPEController.class);
    private XT_TYPE_Dao dao = new XT_TYPE_Dao(); 
    ...
    public void list() {
        ...
        DBResult dbret = dao.Query("*", "XT_TYPE", cWhereParm, cOrderBy, iPageNo, iPageSize);
    ...
    public void save() {
        ...
        vo = (XT_TYPE) RequestUtil.readFromRequest(this.request, vo);
    ...
    public void find_item() {
        ...
        XT_TYPE obj = dao.FindItem(cURL_ID);
