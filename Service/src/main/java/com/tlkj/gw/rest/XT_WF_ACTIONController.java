...
@RequestMapping("/rest/wf_action")
public class XT_WF_ACTIONController extends TLKJController {
    public final static String BASE_URL = "/wf_action";
    static Logger log = Logger.getLogger(XT_WF_ACTIONController.class);
    private XT_WF_ACTION_Dao dao = new XT_WF_ACTION_Dao(); 
    ...
    public void list() {
        ...
        String cWhereParm = "";
        String cOrderBy = " action_id asc";
        DBResult dbret = dao.Query("*", "XT_WF_ACTION", cWhereParm, cOrderBy, iPageNo, iPageSize);
    ...
    public void save() {
        ...
        vo = (XT_WF_ACTION) RequestUtil.readFromRequest(this.request, vo);
    ...
    public void find_item() {
        ...
        XT_WF_ACTION obj = dao.FindItem(cURL_ID);
