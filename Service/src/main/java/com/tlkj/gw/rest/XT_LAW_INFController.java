...
@RequestMapping("/rest/law_inf")
public class XT_LAW_INFController extends TLKJController {
    public final static String BASE_URL = "/law_inf";
    static Logger log = Logger.getLogger(XT_LAW_INFController.class);
    private XT_LAW_INF_Dao dao = new XT_LAW_INF_Dao(); 
    ...
    public void list() {
        ...
        DBResult dbret = dao.Query("*", "XT_LAW_INF", cWhereParm, cOrderBy, iPageNo, iPageSize);
    ...
    public void save() {
        ...
        vo = (XT_LAW_INF) RequestUtil.readFromRequest(this.request, vo);
    ...
    public void find_item() {
        ...
        XT_LAW_INF obj = dao.FindItem(cURL_ID);
